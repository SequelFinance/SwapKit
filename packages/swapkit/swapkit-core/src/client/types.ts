import type { QuoteRoute } from '@sequelfinance/swapkit-api';
import { Amount, AssetAmount, AssetEntity, Pool } from '@sequelfinance/swapkit-entities';
import type {
  BinanceToolbox,
  DepositParam,
  GaiaToolbox,
...
import type { AVAXToolbox, BSCToolbox, ETHToolbox } from '@sequelfinance/toolbox-evm';
import type { BCHToolbox, BTCToolbox, DOGEToolbox, LTCToolbox } from '@sequelfinance/toolbox-utxo';
import {
  AmountWithBaseDenom,
  Chain,
  FeeOption,
