...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@sequel/swapkit-entities': resolve('../../packages/swapkit-entities/src'),
      '@thorswap-lib/swapkit-explorers': resolve('../../packages/swapkit-explorers/src'),
      '@sequel/toolbox-evm': resolve('../../packages/toolbox-evm/src'),
      ...
      '@sequel/types': resolve('../../packages/types/src'),
